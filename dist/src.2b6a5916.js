  ...
  methods: {
    ...
    drag: function drag(event, content) {
      ...
      // firefox not emit clientX and Y by drag
        ...
        var $1f9731 = exports.default || module.exports;
      
      if (typeof $1f9731 === 'function') {
        $1f9731 = $1f9731.options;
      }
    
        /* template */
        Object.assign($1f9731, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1f9731', $1f9731);
          } else {
            api.reload('$1f9731', $1f9731);
          }
        }
